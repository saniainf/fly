namespace ParallaxScrolling
{
    ...
    public class ParallaxScrollingGame : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            _layers[7].Sprites.Add(new Sprite { Texture = Content.Load<Texture2D>("Layer10"), Position = new Vector2(900, 0) });
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (keyboardState.IsKeyDown(Keys.D))
                _layers[7].Sprites[1].Position.X += 400.0f * elapsedTime;

            if (keyboardState.IsKeyDown(Keys.A))
                _layers[7].Sprites[1].Position.X += -400.0f * elapsedTime;

            if (keyboardState.IsKeyDown(Keys.W))
                _layers[7].Sprites[1].Position.Y += -400.0f * elapsedTime;

            if (keyboardState.IsKeyDown(Keys.S))
                _layers[7].Sprites[1].Position.Y += 400.0f * elapsedTime;

            if (keyboardState.IsKeyDown(Keys.Q))
                _layers[7].Sprites[1].Rotation += -0.1f;
            ...
            if (keyboardState.IsKeyDown(Keys.Right))
                _camera.Move(new Vector2(400.0f * elapsedTime, 0.0f));

            if (keyboardState.IsKeyDown(Keys.Left))
                _camera.Move(new Vector2(-400.0f * elapsedTime, 0.0f));

            if (keyboardState.IsKeyDown(Keys.Down))
                _camera.Move(new Vector2(0.0f, 400.0f * elapsedTime));
